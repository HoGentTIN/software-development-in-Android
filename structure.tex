...
{\lstset{language=XML,frame=lines,morekeywords={encoding,
			xs:schema,xs:element,xs:complexType,xs:sequence,xs:attribute},stringstyle=\color{HoGentBlue},basicstyle=\tiny,}}
{}
